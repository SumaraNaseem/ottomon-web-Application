...
const ProductCardsale = ({ items, selectedGrid, pageType, CallingFrom, loading }) => {
                    ...
                    <div className="flex items-center flex-wrap justify-between w-full ">
                        {!isMattresses && (
                            <div className="text-center pt-3">
                                ...
                                }} className="bg-primary cursor-pointer p-3 px-2 xs:ms-[0px] ms-[6px] text-white rounded-md">
